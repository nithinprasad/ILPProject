...
public class VendorProductService {
	...
	public void deleteVendorProductOnProductId(String vendorId, String productId) throws SQLException {
		/**
		 ...
		 */
		VendorProductDao vendorProductDao=new VendorProductDao();
		vendorProductDao.deleteVendorProductOnProductId(vendorId,productId);
	}
