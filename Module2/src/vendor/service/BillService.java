...
public class BillService {
	...
	public ArrayList<PurchaseOrder> searchPO(String poNumber,String vendorId) throws SQLException {
		...
		BillDao billDao=new BillDao();
		return billDao.searchPO(poNumber,vendorId);
	}
	public ArrayList<Appointment> searchAppoinment(String billNo,String vendorId) throws SQLException
	{
		BillDao billDao=new BillDao();
		return billDao.searchAppoinment(billNo,vendorId);
	}
	public VendorBill getVendorBill(String billNo) throws SQLException
	{
		BillDao billDao=new BillDao();
		return billDao.getVendorBill(billNo);
	}
	public Shipment getShipment(String billNo) throws SQLException
	{
		BillDao billDao=new BillDao();
		return billDao.getShipment(billNo);
	}
	public BillDetails getBillDetails(String billNo) throws SQLException
	{
		BillDao billDao=new BillDao();
		return billDao.getBillDetails(billNo);
	}
}
