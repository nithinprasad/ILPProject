...
public class VendorEmployeeService {
	...
	public String deleteVendorEmployee(String vendorId, String employeeId) throws SQLException {
		 ...
		 */
		VendorEmployeeDao employeeDao=new VendorEmployeeDao();
		return employeeDao.deleteVendorEmployee(vendorId,employeeId);
...
public ArrayList<VendorEmployee> searchEmployee(String empId, String vendorId) throws SQLException {
	 ...
	 return	vendorEmployeeDao.searchEmployee(empId,vendorId);
