...
<%
		...
		String empIdCheck = (String)sessionCheck.getAttribute("vendorId");
        if(empIdCheck==null){  
        ...
        %>        
<%
HttpSession sessionCheck1=request.getSession(true);  
String empId = (String)sessionCheck1.getAttribute("empId");
%>
<ul class="nav nav-pills">
 
  <li role="presentation"  class="active"><a href="truckmgmt.jsp">Truck Management</a></li>
  
 <li role="presentation" class="pull-right">
 <div class="dropdown" >
  <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown">User id-<%=empId %> (Vendor Employee)
...
if((truckView!=null))
	{%>
	<form class="form-horizontal " method="post" action="EmpTruckController" name="addTruck">
      ...
      <div class="modal-body">
		...
		<form class="form-horizontal " method="post" action="EmpTruckController" name="addTruck">
  			...
  			<div class="form-group required">
    			<label for="year" class="col-sm-4 control-label">Year Of Registration:</label>
    			<div class="col-sm-6">
      			<input type="number" name="year" class="form-control" pattern="[0-9]{4}" title="Format : for eg:2014" max="2015" min="2000" class="form-control" id="year" placeholder="yyyy" required>
    			</div>
  			</div>
...
<div class="modal fade" id="deleteTruckModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <br><br>
  ...
  <div class="form-group">
    <div class="col-sm-offset-4 col-sm-6">
      <button type="submit" class="btn btn-danger" onclick = "confirmation()">Delete</button>
       <p id="demo"></p>
      ...
      <%
          ...
          {%>
       	   ...
       	   <tr align="center">
       	   		...
       	   		<td><%=truck.getYear() %></td>
       	   		<td><%=truck.getOwner() %></td>
       	   		<form class="form-horizontal " method="post" action="EmpTruckController" name="addVendor">
      			 <input type = "hidden" name = "action" value = "viewTruck">
      			 <input type = "hidden" name="truckId" value =<%=truck.getTruckNo() %>>
      			 <td><button type="submit" class="btn btn-info btn-primary btn-xs">View More</button></td>
      			 </form>
